...
$route->postMethod('checked/replace', 'CheckedMessagesController@replaceIntoTrash');
$route->postMethod('important/replace', 'ImportantMessagesController@replaceIntoTrash');
$route->postMethod('sent/replace', 'SentMessagesController@replaceIntoTrash@replaceIntoTrash');
$route->postMethod('spamed/replace', 'SpamedMessagesController@replaceIntoTrash');