        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-md-8 col-8 p-0" id="main-content">
                ...
                <div class="col-lg-12 d-flex border-bottom" id="tools">
                        <div class="col-lg-3">
                        <form action="/important/replace" class="d-flex" method="post">
                            <!-- Select all button -->
                            ...
                            <!-- Block with ID's of important message for multiple deletion -->
                            <div id="messages" class="d-none">
                                <?php foreach($messages as $message): ?>
                                    <input type="checkbox" name="checkbox<?php echo $message['message_id']; ?>" value="<?php echo $message['message_id']; ?>">
                                <?php endforeach; ?>
                            </div>
                            <!-- Refresh button -->
                            <div class="form-group">
